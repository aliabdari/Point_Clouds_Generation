...
def sample_colored_points_from_obj(obj_file, num_points=50000):
    try:
        ...
        print("[INFO] Load texture images")
        loaded_textures = {}
        ...
        for point in np.asarray(pcd.points):
            ...
            colors.append(color)
        print('[INFO] Saving colored points...')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if len(remained_objs) == 0:
            print('Process Finished')
            break
        print(remained_objs[0])
        sample_colored_points_from_obj(remained_objs[0])
        print('Elapsed Time:', datetime.fromtimestamp(time.time()-start_time))
